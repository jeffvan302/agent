...
set LIBS=user32.lib gdi32.lib comctl32.lib comdlg32.lib shell32.lib shlwapi.lib ole32.lib oleaut32.lib uiautomationcore.lib winhttp.lib cabinet.lib bcrypt.lib crypt32.lib advapi32.lib
